...
var verifier = function (req, res, next) {
    ...
    if ((width !== '' &&
        ...
        !/[a-zA-Z]/.test(width) &&
        parseInt(width) > 0) ||
        ((process !== undefined && process.toUpperCase() !== 'RESIZE') &&
    ...
    if ((angle !== '' && angle !== undefined && !/[a-zA-Z]/.test(angle)) ||
    ...
    if (fs_1.default.existsSync("./assets/full/".concat(fileName, ".jpg")) &&
        ...
        if (!fs_1.default.existsSync("./assets/full/".concat(fileName, ".jpg"))) {
            if (verifiyName === false) {
                ...
                res
                    .status(400)
                    .send("Error, ./assets/full/".concat(fileName, ".jpg doesn't exists!!"));
            }
        }
        ...
        if (verifiyW === false) {
            if (width === undefined) {
                ...
                res
                    .status(400)
                    .send("Error, The image's width must be a non-zero value. Received: ".concat(width));
            }
        }
        ...
        if (verifiyH === false) {
            if (height === undefined) {
                ...
                res
                    .status(400)
                    .send("Error, The image's height must be a non-zero value. Received: ".concat(height));
            }
        }
        ...
        if (verifiyExt === false) {
            if (extension === undefined) {
                ...
                res
                    .status(400)
                    .send("Error, The available image extensions: JPG, JPEG, PNG, WEBP, GIF, AVIF, TIFF");
            }
        }
        ...
        if (verifiyA === false) {
            if (angle === undefined) {
                ...
                res
                    .status(400)
                    .send("Error, The image's rotation angle must hold a value. Received: ".concat(angle));
            }
        }
        ...
        if (verifiyP === false) {
            if (process === undefined) {
                ...
                res
                    .status(400)
                    .send("Error, The available image processes: RESIZE, ROTATE, FLIP, FLOP");
            }
        }
    }
};
